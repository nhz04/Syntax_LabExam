          ...
          <form action="login.php" method="POST" class="space-y-4">
            <div>
              ...
              <input type="text" name="username" required
                     ...
                     class="w-full px-3 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-pink-500">
            </div>
            ...
            <div>
              ...
              <div class="relative">
                <input type="password" name="password" id="password" required
                       class="w-full px-3 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-pink-500 pr-10">
                  ...
                  <svg id="eyeOffIcon" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                          d="M13.875 18.825A10.05 10.05 0 0112 
                             19c-4.478 0-8.268-2.943-9.542-7a9.953 
